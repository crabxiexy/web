...
case class FoundClubPlanner(club_name: String, leader_id: Int, club_intro: String, club_depart: String, profile: String, override val planContext: PlanContext) extends Planner[String] {
