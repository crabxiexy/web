...
case class CreateAppPlanner(club_name: String, leader_name: String, club_intro: String, club_depart: String, override val planContext: PlanContext) extends Planner[String] {
